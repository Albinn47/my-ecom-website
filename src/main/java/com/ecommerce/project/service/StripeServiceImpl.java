...
public class StripeServiceImpl  implements StripeService{
    ...
    //run the method after the bean is created
    @PostConstruct
    public void init(){
    ...
    public PaymentIntent paymentIntent(StripePaymentDTO stripePaymentDTO) throws StripeException {
        Customer customer ;
        //Check and retrieve if customer exist
        ...
        //else fetch the existing customer
        else{
            //get customer at 0th index
