...
public class CartServiceimpl implements CartService{
    ...
    public CartDTO addProductToCart(Long productId, Integer quantity) {
        //Find existing cart ot create one
       Cart cart = createCart();
        ...
        if(cartItem!=null){
          throw new APIException("Product "+product.getProductName()+" already exists in the card");
        }
    ...
    public void updateProductInCarts(Long cartId, Long productId) {
        ...
        //recalculating the price if product price changes
    ...
    public String createOrUpdateCartWithItems(List<CartItemDTO> cartItems) {
        ...
        return "Cart created/updated with new items sucessfully";
    }
